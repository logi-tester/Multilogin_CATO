...
To enter valid username and valid password
    ...
    ${userName}=    Read Cell Data By Coordinates    Sheet1    0    6
    ${userPass}=    Read Cell Data By Coordinates    Sheet1    1    6
...
To Enter valid username and Invalid password
    Jenkins browser launch
    Input Text    xpath=(.//*[@type='text'])[1]    CreatorHeadAdmincreator
...
To Enter Invalid username and valid password
    ...
    Input Text    xpath=(.//*[@type='text'])[2]    CreatorHead123
    Click Element    xpath=(.//*[@type='submit'])[1]
